...
```{r enders-game-cover, out.height="2in", fig.cap="A sci-fi novel featuring an ansible as a communication device."}
...
:   Manage git repositories.
        ...
        - git:
            repo: https://github.com/madison-python/google-survey.git
            dest: /home/pierce/google-survey

pip
:   Package manager for python.

        - pip:
            requirements: /home/pierce/google-survey/requirements.txt
            virtualenv: /home/pierce/.venvs/google-survey
...
:   Retrieve a file from the host(s)
        ...
        - fetch: src=/dumps/today.sql dest=/laptop/today.sql flat=yes

copy
:   Copy a file to the server(s)

        - copy: src=/laptop/yesterday.sql dest=/dumps/yesterday.sql
